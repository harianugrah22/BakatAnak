...
public class Pertanyaan_7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_7);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup7);

        Button button_next = (Button) findViewById(R.id.buttonNext_7);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    Intent  i = new Intent(Pertanyaan_7.this, Pertanyaan_8.class);
                    ...
                    Toast.makeText(Pertanyaan_7.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
