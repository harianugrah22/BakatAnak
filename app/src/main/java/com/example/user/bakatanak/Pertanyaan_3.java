...
public class Pertanyaan_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_3);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup3);

        Button button_next = (Button) findViewById(R.id.buttonNext_3);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    Intent  i = new Intent(Pertanyaan_3.this, Pertanyaan_4.class);
                    ...
                    Toast.makeText(Pertanyaan_3.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
