...
public class Pertanyaan_6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_6);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup6);

        Button button_next = (Button) findViewById(R.id.buttonNext_6);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    Intent  i = new Intent(Pertanyaan_6.this, Pertanyaan_7.class);
                    ...
                    Toast.makeText(Pertanyaan_6.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
