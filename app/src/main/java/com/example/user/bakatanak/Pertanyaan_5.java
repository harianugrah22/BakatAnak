...
public class Pertanyaan_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup5);

        Button button_next = (Button) findViewById(R.id.buttonNext_5);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    Intent  i = new Intent(Pertanyaan_5.this, Pertanyaan_6.class);
                    ...
                    Toast.makeText(Pertanyaan_5.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
