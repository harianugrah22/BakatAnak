...
public class Pertanyaan_4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_4);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup4);

        Button button_next = (Button) findViewById(R.id.buttonNext_4);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    String Pengajar1T= String.valueOf(Pengajar_1+3);
                    String Dokter1T= String.valueOf(Dokter_1+0);
                    String Polisi1T= String.valueOf(Polisi_1+0);

                    Intent  i = new Intent(Pertanyaan_4.this, Pertanyaan_5.class);
                    ...
                    String Pengusaha1T= String.valueOf(Pengusaha_1+0);
                    String Seniman1T= String.valueOf(Seniman_1+0);
                    String Pengajar1T= String.valueOf(Pengajar_1+1);
                    String Dokter1T= String.valueOf(Dokter_1+0);
                    String Polisi1T= String.valueOf(Polisi_1+0);
                    ...
                    Toast.makeText(Pertanyaan_4.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
