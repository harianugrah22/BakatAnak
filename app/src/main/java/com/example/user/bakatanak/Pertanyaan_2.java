...
public class Pertanyaan_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_2);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup2);

        Button button_next = (Button) findViewById(R.id.buttonNext_2);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    Intent  i = new Intent(Pertanyaan_2.this, Pertanyaan_3.class);
                    ...
                    Toast.makeText(Pertanyaan_2.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
