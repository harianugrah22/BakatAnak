...
public class Pertanyaan_9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_9);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup9);

        Button button_next = (Button) findViewById(R.id.buttonNext_9);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    String Polisi1T= String.valueOf(Polisi_1+3);

                    Intent  i = new Intent(Pertanyaan_9.this, Pertanyaan_10.class);
                    ...
                    String Pengajar1T= String.valueOf(Pengajar_1+0);
                    String Dokter1T= String.valueOf(Dokter_1+0);
                    String Polisi1T= String.valueOf(Polisi_1+1);
                    ...
                    Toast.makeText(Pertanyaan_9.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
