...
public class Pertanyaan_10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_10);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup10);

        Button button_next = (Button) findViewById(R.id.buttonNext_10);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Setuju")){
                    ...
                    String Dokter1T= String.valueOf(Dokter_1+3);
                    String Polisi1T= String.valueOf(Polisi_1+0);

                    Intent  i = new Intent(Pertanyaan_10.this, Pertanyaan_11.class);
                    ...
                    String Seniman1T= String.valueOf(Seniman_1+0);
                    String Pengajar1T= String.valueOf(Pengajar_1+0);
                    String Dokter1T= String.valueOf(Dokter_1+1);
                    String Polisi1T= String.valueOf(Polisi_1+0);
                    ...
                    Toast.makeText(Pertanyaan_10.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
