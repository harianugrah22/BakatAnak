...
public class Pertanyaan_11 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pertanyaan_11);
        ...
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.RGroup11);

        Button button_next = (Button) findViewById(R.id.buttonNext_11);
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai.equals("Bisa membayangkan bagaimana sesuatu akan dibuat")){
                    ...
                    Intent  i = new Intent(Pertanyaan_11.this, Pertanyaan_12.class);
                    ...
                    startActivity(i);
                } else if (nilai.equals("Mampu dengan mudah mengorganisir berbagai hal yang dimiliki")){
                    ...
                    i.putExtra("Polisi",Polisi1T);
                    startActivity(i);
                } else if (nilai.equals("Senang menciptakan sesuatu sesuai isi hati")){
                    String Pengusaha1T= String.valueOf(Pengusaha_1+0);
                    ...
                    i.putExtra("Polisi",Polisi1T);
                    startActivity(i);
                } else if (nilai.equals("Mengembalikan sesuatu menjadi seperti kondisi semula")){
                    String Pengusaha1T= String.valueOf(Pengusaha_1+0);
                    String Seniman1T= String.valueOf(Seniman_1+0);
                    String Pengajar1T= String.valueOf(Pengajar_1+0);
                    ...
                    i.putExtra("Polisi",Polisi1T);
                    startActivity(i);
                }else if (nilai.equals("Menyampaikan informasi dengan sederhana dan mudah dimengerti")){
                    String Pengusaha1T= String.valueOf(Pengusaha_1+0);
                    String Seniman1T= String.valueOf(Seniman_1+0);
                    ...
                    Toast.makeText(Pertanyaan_11.this,"Jawaban Belum Diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
